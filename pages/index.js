  ...
  return (
    <>
      ...
      <main className='home flex flex-col items-center bg-black text-white '>
        ...
        <div className=' w-[60vw] h-full md:h-[100vh] mt-20 text-center'>
        ...
        dark:bg-gray-200 py-5 rounded-md px-10 relative md:absolute  mt-[20%] lg:mt-[40%] shadow-md'>
          <div>
            <h1>Location</h1>
      ...
      <Homes location={location} houseType={houseType} priceRange={priceRange} />
